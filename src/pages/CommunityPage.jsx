...
const CommunityPage = () => {
  ...
  const filters = ['Depression', 'Sexuality', 'Trauma', 'Relationship', 'General', 'Addiction'];
  ...
  const filteredResources = resources.filter((resource) => {
    ...
    return resource.specialities.some((speciality) => searchedSpecialities.includes(speciality));
  });
  return (
